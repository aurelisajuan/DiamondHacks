    ...
    server: {
        ...
        headers: {
            "Content-Security-Policy":
                "script-src 'self' 'unsafe-inline' 'wasm-unsafe-eval' 'inline-speculation-rules' http://localhost:* http://127.0.0.1:* chrome-extension://9116c1a2-88fa-4020-ac1f-b03111be01b3/",
        },
    },
    build: {
        modulePreload: {
